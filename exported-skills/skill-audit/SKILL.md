---
name: skill-audit
description: "Audits all exported skills against their sources. Detects stale exports, orphaned exports, and reports portability scores. Use before /push-skills or after editing skills to confirm the export layer is clean."
allowed-tools:
  - Glob
  - Bash(git log *)
  - Bash(python3 *)
