...
evidence: "First use 2026-04-25 — extracted from project-life-134 PRs #7 + #8 + #9 (ADR 0008 follow-up #2 closure). 3 PRs, 2 latent bugs caught (heredoc + plaintext_value deprecation), end-to-end verified via auto-trigger chain on `main` (run 24933548851: 0 to add / 0 to change / 0 to destroy + 0 deprecation warnings)."
scope: global
portability: 100
