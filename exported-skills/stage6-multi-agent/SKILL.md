...
description: "Deploys the multi-agent orchestration layer — Agent Router + ops/code/research sub-agents + infra-agent stub — on top of an N8N instance, and wires [your-telegram] free-form Hebrew into the Router. Verifies with a 10-probe Macro-F1 ≥ 0.85 gate (ADR 0034). Use after Stages 1–5 are complete."
allowed-tools:
  - Read
  - Edit
  - Write
