...
description: "Scans current session and [your-journey-file] for recurring workflow patterns; surfaces ranked SKILL.md candidates with recurrence counts. Use when harvesting skill candidates, identifying reusable workflows, or extracting skills from session retrospective."
allowed-tools:
  - Read
  - Bash
