...
evidence: "First use 2026-04-16. Simplified to always use commands mode 2026-04-17: plugins mode created files but not registered slash commands; commands mode works reliably."
scope: global
portability: 70
